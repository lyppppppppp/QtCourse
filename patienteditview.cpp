    ...
    , ui(new Ui::PatientEditView)
{
    ...
    QSqlTableModel *tabModel = IDdatabase::getInstance().patientTabModel;
    dataMapper->setModel(IDdatabase::getInstance().patientTabModel);
...
{
    IDdatabase::getInstance().submitPatientEdit();
...
{
    IDdatabase::getInstance().revertPatientEdit();
